...
//        626f11a289
        ...
        System.out.println(RestAssured.given().when().get("https://loopme.me/api/v3/ads?callback=L" +
                ".loadAdSucess&ak=626f11a289&vt=7nd3gly3ys").then().extract().response());

        System.out.println(RestAssured.get("https://loopme.me/api/v3/ads?callback=L" +
                ".loadAdSucess&ak=626f11a289&vt=7nd3gly3ys").asString());
